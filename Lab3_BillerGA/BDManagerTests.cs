...
namespace Lab3_BillerGA.Tests
{
    ...
    public class BDManagerTests
    {
        ...
        public void BDManager_AddTriangleData_FileWriteCalled()
        {
            ...
            var initialFileExists = File.Exists("C:/Users/Alexandra/source/repos/Lab3_KosinovaAi/triangles.jsontriangles.json");

            // Act
            dbManager.AddTriangleData(3, 4, 5, "Прямоугольный", "Это треугольник с соотношением сторон 3:4:5");

            // Assert
            var fileCreated = File.Exists("C:/Users/Alexandra/source/repos/Lab3_KosinovaAi/triangles.jsontriangles.json");
        ...
        public void AddTriangleData_FileWriteCalled()
        {
            // Arrange
            var dbManager = new BDManager();
            var initialFileExists = File.Exists("C:/Users/Alexandra/source/repos/Lab3_KosinovaAi/triangles.jsont");
      ...
      //      Assert.IsNotNull(triangles);
        ...
        public void SaveData_WritesTriangularListToFile()
        {
         ...
         //   dbManager.SaveData(triangles);
            ...
            // Assert
            var jsonData = File.ReadAllText("C:/Users/Alexandra/source/repos/Lab3_KosinovaAi/triangles.jsontriangles.json");
