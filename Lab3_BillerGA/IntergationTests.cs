...
namespace Lab3_BillerGA.Tests
{
    ...
    public class IntegrationTests
    {
        ...
        public void BDManager_AddTriangleData_FileWriteCalled()
        {
            ...
            System.IO.File.Delete("C:/Users/Alexandra/source/repos/Lab3_KosinovaAi/triangles.jsontriangles.json");

            // Act
            dbManager.AddTriangleData(3, 4, 5, "Прямоугольный", "Это треугольник с соотношением сторон 3:4:5");

            // Assert
            Assert.That(System.IO.File.Exists("C:/Users/Alexandra/source/repos/Lab3_KosinovaAi/triangles.jsontriangles.json"));
        }
